...
const CV = ({ className, onClick }: ICV) => {
  return (
    <svg id="062a65d4-6310-416e-8fb8-777315adf84b" 
    width="153.53" height="170" viewBox="0 0 853.53 770">
    <defs>
        ...
        <linearGradient id="87908c47-1c47-4a2f-b745-20cb7009bb75" x1="685.97" y1="797.2" x2="685.97" y2="126.94" gradientTransform="translate(-242.89 51.18) rotate(-10.87)" />
        <linearGradient id="f482b758-09b8-4320-b57c-ecd1bdf3658e" x1="517.93" y1="719.46" x2="517.93" y2="49.68" gradientTransform="matrix(1, 0, 0, 1, 0, 0)" />
        ...
        <linearGradient id="e8979000-d63e-4fe0-8af1-0dfdd65d3420" x1="356.17" y1="639.4" x2="356.17" y2="574" gradientTransform="matrix(1, 0, 0, 1, 0, 0)"/>
        <linearGradient id="3889af47-bc7c-4009-b8ee-af9d60c73d61" x1="296" y1="675.66" x2="296" y2="478.3" gradientTransform="matrix(1, 0, 0, 1, 0, 0)" />
    </defs>
    <title>files</title>
    ...
    <polygon points="793.7 760.47 317.27 721.39 369.78 71.81 846.21 110.88 793.7 760.47" fill="#0e555b"/>
    ...
    <path d="M770.09,227.84c0-43.62-35.1-79-78.41-79s-78.41,35.36-78.41,79a79,79,0,0,0,51.86,74.33V281.83a26.72,26.72,0,0,1,26.55-26.74h0a26.72,26.72,0,0,1,26.55,26.74v20.35A79,79,0,0,0,770.09,227.84Z" transform="translate(-173.24 -65)" fill="#0e555b"/>
    ...
    <rect x="329.3" y="579.64" width="53.73" height="54.12" fill="#0e555b"/>
    ...
    <rect x="440.13" y="585.27" width="156.72" height="11.28" fill="#0e555b"/>
    ...
    <ellipse cx="99.82" cy="511.98" rx="78.36" ry="78.93" fill="#0e555b"/>
